...
abstract class CommonTest extends PHPUnit_Framework_TestCase
{
    ...
    public function stringsForContains()
    {
        $testData = array(
            ...
            array(true, '12398!@(*%!@# @!%#*&^%',  ' @!%#*&^%'),
            array(true, 'Ο συγγραφέας είπε', 'συγγραφέας', true, 'UTF-8'),
            ...
            array(false, 'This string contains foö bar', 'Foo bar', false),
            array(true, 'This string contains foö bar', 'Foö bar', false),
        );
